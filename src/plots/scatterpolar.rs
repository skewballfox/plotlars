...
impl ScatterPolar {
    ...
    pub fn new(
        ...
        let traces = Self::create_traces(
            data, theta, r, group, sort_groups, mode, opacity, fill, size, color, colors, shape, shapes, width,
            line, lines,
        );
    ...
    fn create_traces(
        ...
        match group {
            Some(group_col) => {
                let groups = Self::get_unique_groups(data, group_col, sort_groups.unwrap_or(true));
